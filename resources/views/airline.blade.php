...
<body class="h-full">
    <div class="bg-white h-full flex gap-10">
            ...
            <div class="-m-1.5 overflow-x-auto h-full">
                <div class="p-1.5 min-w-full inline-block align-middle h-full">
                    <div class="overflow-hidden flex flex-col gap-7 items-center text-left relative h-full">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody id="airlineTable" class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">{{ $airline->name }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800">{{ $airline->description }}</td>
                        ...
                        <div id="modal" class="absolute top-56 bg-white shadow-2xl rounded-lg p-7 hidden">
                            <form id="updateForm" class="flex flex-col gap-5" method="PUT">
                                <div class="flex justify-between">
                                    <h1 class="text-3xl">To update</h1>
